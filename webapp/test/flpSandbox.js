		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#multiplicationtable1multiplicationtableproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"multiplicationtable1multiplicationtableproject-display": {
								"semanticObject": "multiplicationtable1multiplicationtableproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=multiplicationtable1.multiplicationtableproject",
									"url": sap.ui.require.toUrl("multiplicationtable1/multiplicationtableproject")
								}
							}
						}
					}
